...
if __name__ == "__main__":
    ...
    file_db = pd.read_excel(args.path_db)
    file_jotform = pd.read_excel(args.path_jotform)
    log_file = generate_log_file()

    main_verification(file_jotform, file_db, log_file)
    print(f"Log de vérification généré : {log_file}")
